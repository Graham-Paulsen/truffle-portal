      ...
      >
        <span class="flex items-center gap-3">
          <span
            ...
            :class="modelPreference === option.value ? 'border-white bg-white' : 'border-lavender/40'"
          >
            <span v-if="modelPreference === option.value" class="w-2 h-2 rounded-full bg-cyclamen" />
          </span>
          {{ option.label }}
        </span>
      </button>
