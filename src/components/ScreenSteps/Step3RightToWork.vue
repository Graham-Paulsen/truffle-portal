      ...
      >
        <span class="flex items-center gap-3">
          <span
            ...
            :class="modelStatus === option.value ? 'border-cyclamen bg-cyclamen' : 'border-lavender/40'"
          >
            <span v-if="modelStatus === option.value" class="w-2 h-2 rounded-full bg-white" />
          </span>
          {{ option.label }}
        </span>
      </button>
